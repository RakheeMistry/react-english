...
function App() {
  ...
  return (
    <>
     ...
     items-center bg-cover bg-no-repeat' style={{ backgroundImage: `url('${'https://images.pexels.com/photos/904735/pexels-photo-904735.jpeg?auto=compress&cs=tinysrgb&w=400'}')`, }}>
